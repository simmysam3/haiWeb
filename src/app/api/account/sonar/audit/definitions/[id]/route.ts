...
// template's prior runs (delete | archive | keep — haiCore enforces
// audit-only 'archive' server-side). Validated here against the closed
// protocol enum before it ever reaches the haiCore client, which
