...
const navSections: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: "/account/monitoring/audit-nominations", label: "Audit Nominations" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/account/sonar/templates?modality=phantom_demand", label: "Phantom Demand" },
      { href: "/account/sonar/phantom-demand/reports/latest", label: "Phantom Demand Reports" },
      { href: "/account/sonar/watcher/dashboard", label: "Watcher Dashboard" },
