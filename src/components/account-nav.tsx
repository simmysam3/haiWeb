...
const navSections: NavSection[] = [
  {
    // v.1.43: Sonar Observe trimmed to the watcher / phantom-demand /
    // request-management surfaces. The Backlog (Events / Gaps / Obligations)
    // relocated to Sonar Audit as "Event Backlog" — it's an audit-data
    // workflow, not a watcher one. Lead-time event kinds were dropped from
    // the Events surface at the same time.
    label: "Sonar Observe",
